...
public class Transformer_: MonoBehaviour {
	...
	public tk2dUIItem m_uiItem = null;
	...
	public void BeginTransform(){
		if(m_parent != null)
			Helper__.SetLayer(m_parent, "DisalbedUI");
		Helper__.SetLayer(m_target, "DisalbedUI");
	...
	void EndTransform(){
		if(m_parent != null)
			Helper__.SetLayer(m_parent, "EnabledUI");
		Helper__.SetLayer(m_target, "EnabledUI");
